export const experiences = [
  ...
  },
  {
    ...
    period: "2023-Present",
    description: [
      "Built multi-model ensemble prediction system for NCAA March Madness 2026 ($50K Kaggle competition) using XGBoost, LightGBM, and Logistic Regression with custom Elo ratings, spline calibration, and a fully interactive bracket predictor deployed to the web.",
      ...
      "Developed an AI-powered Voicemail & Call Categorizer using Streamlit, OpenAI Whisper, and NLP (spaCy, Regex) to transcribe and organize client calls for business action.",
      ...
      "Built an ATS-friendly Resume Generator and Common Core Math Worksheet Generator using Python (Flask, pandas, ReportLab).",
    ],
  },
  {
  ...
  },
  {
    ...
    period: "2007-2023",
    description: [
      "Leveraged internal systems and sales records to make <b>data-driven decisions</b>, optimizing inventory management and product placement across multiple departments.",
      "Utilized <b>Excel</b> and <b>Google Sheets</b> for <b>data analysis</b>, <b>reporting</b>, and <b>inventory optimization</b> — including <b>Pivot Tables</b>, <b>VLOOKUP</b>, and automated workflows with <b>macros</b>.",
      "Performed <b>data cleaning</b> and <b>ETL</b> tasks to ensure accurate <b>KPI tracking</b> and support <b>process improvement</b> initiatives.",
      "Took ownership of department performance, implementing process improvements that increased operational efficiency.",
      "Held a Supervisor role overseeing front-end operations, managing cashiers and assistants.",
    ],
  },
];
